...
def branch_and_bound(my_model: Model) -> Tuple[Model, bool]:
    global primal_limit
    ...
    if generated_model_and_status_for_left_side[1]:
    ...
    if generated_model_and_status_for_right_side[1]:
    ...
    if generated_model_and_status_for_right_side[1] and generated_model_and_status_for_left_side[1]:

        if generated_model_and_status_for_right_side[0].objective_value > generated_model_and_status_for_left_side[0].objective_value:
            if generated_model_and_status_for_right_side[0].objective_value >= primal_limit:
                return generated_model_and_status_for_right_side[0], generated_model_and_status_for_right_side[1]

        else:
            if generated_model_and_status_for_left_side[0].objective_value >= primal_limit:
                return generated_model_and_status_for_left_side[0], generated_model_and_status_for_left_side[1]

    elif generated_model_and_status_for_right_side[1]:
        if generated_model_and_status_for_right_side[0].objective_value >= primal_limit:
            return generated_model_and_status_for_right_side[0], generated_model_and_status_for_right_side[1]

    elif generated_model_and_status_for_left_side[1]:
        if generated_model_and_status_for_left_side[0].objective_value >= primal_limit:
            return generated_model_and_status_for_left_side[0], generated_model_and_status_for_left_side[1]
